<template>
  <div style="z-index: 300 !important" class="sidebar-left custom-md-none">
    <div class="sidebar">
    ...
    <template #body>
      <form @submit.prevent="onEditParticipant">
        ...
        >
          <div class="col-md-3 col-12">
            ...
            <div class="input-group mb-1">
              <span
                ...
                :style="{ border: '1px solid' + '#003bb3', color: '#003bb3' }"
              >
          ...
          <div class="input-group mb-1">
          <span class="input-group-text p-0" :style="{ border: '1px solid' + '#003bb3', color: '#003bb3' }">
            <Icon icon="ri:grid-fill" />
          </span>
            <input :readonly="!userDocument.is_the_owner_of_document" type="phone" name="phone"
                v-model="participant.user.phone" class="form-control form-control-sm" :style="{ border: '1px solid' + '#003bb3' }" />
          </div>
        </div> -->
          <div class="col-md-3 col-12">
