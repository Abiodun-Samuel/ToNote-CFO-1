<template>
  <template v-if="is_notary">
    <div v-show="!prints.NotaryDigitalSeal && !prints.NotaryTraditionalSeal">
      <p class="text-center"><i>Kindly create your seal</i></p>
      <button
        type="button"
        @click="createSealModal = true"
    ...
    <div v-show="prints.NotaryDigitalSeal || prints.NotaryTraditionalSeal">
      ...
      <div class="grid my-1" v-if="prints?.NotaryDigitalSeal?.length">
        <label
          v-for="(print, index) in prints?.NotaryDigitalSeal"
          :key="index"
        ...
        >
          ...
          >
            ...
            <template v-else>
              <p
                class="mt-3"
                v-if="index == prints.NotaryDigitalSeal.length - 1"
              >
      ...
      <div class="grid my-1" v-if="prints?.NotaryTraditionalSeal?.length">
        <label
          v-for="(print, index) in prints?.NotaryTraditionalSeal"
          :key="index"
          class="form-check-label border"
          :for="print.id"
        >
          ...
          >
            ...
            <template v-else>
              <p
                class="mt-3"
                v-if="index == prints.NotaryTraditionalSeal.length - 1"
              >
                <i>Kindly create a signature!</i>
              </p>
            </template>
  ...
  <template v-if="!is_notary">
    ...
    <div v-show="prints.CompanySeal">
      ...
      <div class="grid">
        <label
          v-for="(print, index) in prints.CompanySeal"
          :key="index"
          class="form-check-label border"
          :for="print.id"
        >
...
const { prints, is_notary } = useGetters({
  prints: "print/prints",
